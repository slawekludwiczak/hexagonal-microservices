...
public class ElementExistDeactivationSpecification implements Predicate<Response> {
    private final Selector selector;
    private final ElementExtractor elementExtractor;

    public ElementExistDeactivationSpecification(Selector selector,
